            ...
            <div className="bag-product-slider small-pr-slider cat-section">
              ...
              <div style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                  ...
                  <h2>НАШИ ПРЕПОДАВАТЕЛИ »</h2>
                    ...
                    <div>
                        <button onClick={prevStudent}>назад</button><button onClick={nextStudent}>след</button>
                    </div>
                </div>
                      ...
                      <div className="col-item">
                        ...
                        <div className="info">
                          <div className="info-inner">
                            <div className="item-title"> <a title=" Sample Product" href="http://ow.ly/XqzNo"> edu </a> </div>
                            <div className="item-content">
                              ...
                              <div className="price-box">
                                ...
                                <p className="old-price"> <span className="price-sep">-</span> <span className="price"> $0.04 </span> </p>
                              </div>
                            </div>
                          </div>
